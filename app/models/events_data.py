...
class EventsData(UserMixin, db.Model):
    ...
    def __init__(self, id_event, name_player, sex_player, age_player, gun_player, section_player):
    ...
    def __repr__(self):
        return '%d, %d, %s, %s, %s, %s, %s' % (self.id, self.id_event, self.name_player, self.sex_player,
                                               self.age_player, self.gun_player, self.section_player)
